...
const CitizenEnvModal: React.FC = () => {
  ...
  useEffect(() => {
    const fetchEnvRecords = async () => {
      ...
      try {
        const response = await fetch(`http://localhost:8000/api/${citizenId}/env`,
          {
            method: "GET",
            headers: {
...
export default CitizenEnvModal;
